...
(
		{ 
	        newCompositeNode(grammarAccess.getEntityAccess().getNameValidIDParserRuleCall_3_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getEntityAccess().getTypeJvmTypeReferenceParserRuleCall_5_0()); 
	    }
