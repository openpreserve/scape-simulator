...
public class SimulatorSyntacticSequencer extends AbstractSyntacticSequencer {

	protected SimulatorGrammarAccess grammarAccess;
	protected AbstractElementAlias match_KeyValue_DECIMALTerminalRuleCall_1_or_STRINGTerminalRuleCall_2;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (SimulatorGrammarAccess) access;
		match_KeyValue_DECIMALTerminalRuleCall_1_or_STRINGTerminalRuleCall_2 = new AlternativeAlias(false, false, new TokenAlias(false, false, grammarAccess.getKeyValueAccess().getDECIMALTerminalRuleCall_1()), new TokenAlias(false, false, grammarAccess.getKeyValueAccess().getSTRINGTerminalRuleCall_2()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if(match_KeyValue_DECIMALTerminalRuleCall_1_or_STRINGTerminalRuleCall_2.equals(syntax))
				emit_KeyValue_DECIMALTerminalRuleCall_1_or_STRINGTerminalRuleCall_2(semanticObject, getLastNavigableState(), syntaxNodes);
