 ...
 *   <li>{@link eu.scape_project.pw.simulator.impl.KeyValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class KeyValueImpl extends MinimalEObjectImpl.Container implements KeyValue
{
  ...
  public void setValue(int newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SimulatorPackage.KEY_VALUE__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SimulatorPackage.KEY_VALUE__KEY:
        return getKey();
      case SimulatorPackage.KEY_VALUE__VALUE:
        return getValue();
    }
