...
public class SimulatorStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new eu.scape_project.SimulatorRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.scape_project.eu/Simulator")) {
		EPackage.Registry.INSTANCE.put("http://www.scape_project.eu/Simulator", eu.scape_project.simulator.SimulatorPackage.eINSTANCE);
	}
