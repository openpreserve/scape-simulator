...
import eu.scape_project.simulator.*;
...
public class SimulatorFactoryImpl extends EFactoryImpl implements SimulatorFactory
{
  ...
  public static SimulatorFactory init()
  {
    try
    {
      SimulatorFactory theSimulatorFactory = (SimulatorFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.scape_project.eu/Simulator"); 
